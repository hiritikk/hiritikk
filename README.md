...
- Neurotech & Hardware (OpenBCI, EEG/ECG, PyQt6, Raspberry Pi)

> [!IMPORTANT]
> Majority of my activity on GitHub is in private repositories,
> including with organizations like [NeurAlbertaTech](https://nat.ltd).

---

🎓 **Education**
- [University of Alberta](https://ualberta.ca): B.Sc. Specialization in Computing Science

💼 **Experience**
- **SWE Intern** · Dotdash Meredith / People Inc. 
- **Research Assistant** · UofA / Sunmor Research
- **Technology Lead** · NeurAlbertaTech

🧠 **Interests**
- Reinforcement Learning & Robotics
- AI-powered Workflow Automation
- Building products people actually use
- & Web Development (Not sure how useful this is now 💀)
